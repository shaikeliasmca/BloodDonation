...
%>
		...
		try {
			if(username.equalsIgnoreCase("elias"))
				{
				out.print("Welcome    " + username);
			    //out.print("<table>");
				out.println("<br><br><a href='customeradmin.jsp'> Go To Donors Administration </a><br>");
				out.println("<br><a href='ordersadmin.jsp'> Go To Recipient Administration </a><br>");
				}
